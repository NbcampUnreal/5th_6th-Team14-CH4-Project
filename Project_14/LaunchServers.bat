...
start "GameServer1" %UE_EXE% %UPROJECT% /Game/Level/BK_DevLevel -server -log -port=7778

echo 게임 서버2 실행 (Port: 7779)...
start "GameServer2" %UE_EXE% %UPROJECT% /Game/Level/BK_DevLevel -server -log -port=7779
